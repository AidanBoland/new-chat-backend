...
//#[get("/")]
//fn index() -> String {
//   let mut client = match Client::connect("host=localhost user=***REMOVED***", NoTls) {
...
//}
fn main() {
    let mut client = match Client::connect("host=localhost dbname=chat_app user=***REMOVED***", NoTls)
    {
        Ok(client) => client,
